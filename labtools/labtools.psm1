...
switch ($PsCmdlet.ParameterSetName)
    ...
    "nve"
        ...
        switch ($nve_ver)
            ...
            "9.2.0.3"
             ...
             '9.2.0.4'
                {
                $url = 'ftp://ftp.legato.com/pub/NetWorker/NVE/9.2.0/9.2.0.4/ova-9.2-93_9.2.0-172.tar.gz'    
                }                                 
            '9.2.0.5'
                {
                $url = "ftp://ftp.legato.com/pub/NetWorker/NVE/9.2.0/9.2.0.5/ova-9.2-95_9.2.0-182.tar.gz"
                }
            '9.2.1.1'
                {
                $url = "ftp://ftp.legato.com/pub/NetWorker/NVE/9.2.1/9.2.1.1/ova-9.2.1-194_9.2.1-168.tar.gz"
                }    
            }
    ...
    "nve_update"
        ...
        switch ($nve_ver)
            ...
            '9.2.0.4'
                {
                $url = 'ftp://ftp.legato.com/pub/NetWorker/NVE/9.2.0/9.2.0.4/avp-9.2-93_9.2.0-172.tar.gz'    
                }
            '9.2.0.5'
                {
                $url = "ftp://ftp.legato.com/pub/NetWorker/NVE/9.2.0/9.2.0.5/avp-9.2-95_9.2.0-182.tar.gz"    
                }
            '9.2.1.1'
                {
                $url = "ftp://ftp.legato.com/pub/NetWorker/NVE/9.2.1/9.2.1.1/avp-9.2.1-194_9.2.1-168.tar.gz"
                }
            }
		if ($url)
			{
...
[CmdletBinding(DefaultParametersetName = "1",
    ...
    $SQL2016_SSMS = 'https://download.microsoft.com/download/0/A/E/0AE3B5C9-0D22-4EF3-B48A-73181A7F8EF7/SSMS-Setup-ENU.exe'
    $SSMS_LATEST = '17.4'
	#$SSMS_LATEST = '16.5.3'
	$Product_Dir = Join-Path $Destination $Product_Dir
...
"/usr/bin/netplan generate;/usr/sbin/netplan apply")        
	...
	$Scriptblock="apt-get update;DEBIAN_FRONTEND=noninteractive apt-get install -y -o Dpkg::Options::=`"--force-confdef`" -o Dpkg::Options::=`"--force-confold`" ca-certificates $required_packages -y"
    Set-LABUi -short -title $Scriptblock
    $Bashresult = $NodeClone | Invoke-VMXBash -Scriptblock $Scriptblock -Guestuser $Rootuser -Guestpassword $Guestpassword -logfile $Logfile
